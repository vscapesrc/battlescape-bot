...
public class Mouse
{
    ...
    private static void splineMouse()
    {
    ...
    private static double createSmartControlPoint(int n, double spacing, boolean yValue, int distance)
    {
    ...
    private static void createSpline(Point start, Point end)
    {
    ...
    public static void setMousePos(int x, int y)
    {
        ...
        try
        {
            BSLoader.getLoader().processEvent(new MouseEvent(FAKE_SOURCE, 503, System.currentTimeMillis(), 0, x, y, 0, false, 0));
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    private static void moveMouseInternal(int curX, int curY, int x, int y)
    {
    ...
    public static void moveMouse(int x, int y, int randomX, int randomY)
    {
    ...
    public static void pressMouse(int x, int y, boolean button)
    {
        if(x < 0 || y < 0 || x > 756 || y > 503)
            return;
        try
        {
            BSLoader.getLoader().processEvent(new MouseEvent(FAKE_SOURCE, 501, System.currentTimeMillis(), 0, x, y, 1, false, button ? 1 : 3));
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    public static void releaseMouse(int x, int y, boolean button)
    {
        if(x < 0 || y < 0 || x > 756 || y > 503)
            return;
        try
        {
        	BSLoader.getLoader().processEvent(new MouseEvent(FAKE_SOURCE, 502, System.currentTimeMillis(), 0, x, y, 1, false, button ? 1 : 3));
        	BSLoader.getLoader().processEvent(new MouseEvent(FAKE_SOURCE, 500, System.currentTimeMillis(), 0, x, y, 1, false, button ? 1 : 3));
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    public static void clickMouse(Point p, int randomX, int randomY, boolean button)
    {
    ...
    public static void clickMouse(Point p, boolean button)
    {
        clickMouse(p, 0, 0, button);
    }

    public static void moveMouse(Point p, int randomX, int randomY)
    {
    ...
    public static void clickMouse(boolean button)
    {
        clickMouse(getLocation().x, getLocation().y, button);
    }
    
    public static void clickMouse2(Point p, boolean button){
    ...
    public static Point getLocation()
    {
        try
        {
            Point appletPos = BSLoader.getLoader().mousePos;
    ...
    private static DoublePoint points[];
    private static final Random random = new Random();
    private static final java.util.List SPLINE_LINES = new LinkedList();
    private static final java.util.List OUTLINE_LINES = new LinkedList();
    private static final java.util.List OUTLINE_POINTS = new LinkedList();
    private static final double FIXED_MOUSE_SPEED = 0.050000000000000003D;
    public static final Container FAKE_SOURCE = new Container();
