...
public class AIOFisher extends Script {
	 ...
	 */
	static TilePath toLobsters = new TilePath(new RSTile(2587, 3419),
			new RSTile(2595, 3414), new RSTile(2601, 3405), new RSTile(2611,
					3411));

	static TilePath lobstersToBank = toLobsters.reverse();

	static TilePath toManta = new TilePath(new RSTile(2587, 3419), new RSTile(
			2595, 3420), new RSTile(2603, 3425));

	static TilePath mantaToBank = toManta.reverse();

	static TilePath shrimpToBank = new TilePath(new RSTile(2603, 3411),
			new RSTile(2595, 3412), new RSTile(2587, 3419));

	static TilePath toShrimp = shrimpToBank.reverse();
	...
	enum Fish {
		MANTA(196, "Harpoon", "Harpoon", 2800, mantaToBank, toManta), LOBSTER(
				191, "Lobster pot", "Cage", 1800, lobstersToBank, toLobsters), SHRIMP(
				186, "Small fishing net", "Net", 200, shrimpToBank, toShrimp);
		...
		private Fish(int npcId, String itemName, String fishAction,
